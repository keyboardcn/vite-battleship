...
import {SectionComponent, CenterCardComponent, LabelInputComponent, ButtonComponent} from "../../commons/common.components";

export interface IUser {
    [key: string]: any
}
export function LoggedUserComponent({props}: IUser) {
    // Omit the last item if number of keys is odd
